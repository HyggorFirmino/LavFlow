...
interface AddCardModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (card: Partial<Omit<Card, 'id' | 'listId'>> & { id?: string }) => void;
...
const AddCardModal: React.FC<AddCardModalProps> = ({ isOpen, onClose, onSave, cardToEdit, allTags, tagsMap, currentUser }) => {
