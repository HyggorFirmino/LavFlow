...
interface AddListModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (title: string, limit: number | null, type: 'default' | 'dryer' | 'lavadora', totalDryingTime?: number, reminderInterval?: number) => void;
}

const AddListModal: React.FC<AddListModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    onSave(title, newLimit, type, newTotalTime, newReminderInterval);
  };
