...
interface AddListModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (title: string, limit: number | null, type: 'default' | 'dryer' | 'lavadora' | 'whatsapp' | 'conclusao', storeId: number, totalDryingTime?: number, reminderInterval?: number, alertaSonoro?: string) => void;
  stores: Store[];
...
const AddListModal: React.FC<AddListModalProps> = ({ isOpen, onClose, onSave, stores, currentStoreId }) => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    onSave(title, newLimit, type, Number(selectedStoreId), newTotalTime, newReminderInterval, alertaSonoro);
  };
